...
drop table IF EXISTS lancamentos_produto;
drop table IF EXISTS lancamentos_servico;
...
Alter table lancamentos add Foreign Key (tip_codigo) references tipos (tip_codigo) on delete cascade on update cascade;
