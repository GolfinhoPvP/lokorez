...
INSERT INTO cep (est_codigo, cid_codigo, bai_codigo, tip_codigo, log_codigo, cep_cep)
		(SELECT cid.est_codigo, cid.cid_codigo, bai.bai_codigo, tip.tip_codigo, logr.log_codigo, br.cep FROM br_estado_pe br 
			INNER JOIN cidades cid
				ON br.cidade = cid.cid_nome
			INNER JOIN bairros bai
				ON br.bairro = bai.bai_nome
...
INSERT INTO cep (est_codigo, cid_codigo, bai_codigo, tip_codigo, log_codigo, cep_cep)
		(SELECT cid.est_codigo, cid.cid_codigo, bai.bai_codigo, tip.tip_codigo, logr.log_codigo, br.cep FROM br_estado_pr br 
			INNER JOIN cidades cid
				ON br.cidade = cid.cid_nome
			INNER JOIN bairros bai
				ON br.bairro = bai.bai_nome
