			...
			for($x=0; $x<$numRows; $x++){
				...
				switch($this->tableId){
					...
					case "cadastro" : $date = explode("-",$_SESSION["day"]);
									...
									$query = "SELECT * FROM Cadastros WHERE matricula='".$this->DB[$x][0]."' AND codigo_fol=".$code;
									...
									if($code == 1){
										...
										if($cont > 0){
											$aux = array("UPDATE Cadastros SET cargo='".$this->DB[$x][10]."', lotacao='".$this->DB[$x][1]."', data_admissao='".$this->dateFormater($this->DB[$x][4])."', vinculo='".$this->DB[$x][5]."', previdencia'".$this->DB[$x][7]."', nivel='".$this->DB[$x][11]."', dep_imp_re='".$this->DB[$x][13]."', hora_sem='".$this->DB[$x][15]."', instrucao='".$this->DB[$x][16]."', data_afastamento='".$this->dateFormater($this->DB[$x][20])."', sindical='".$this->DB[$x][21]."', dp_sal_fam='".$this->DB[$x][22]."', hora_ponto='".$this->DB[$x][23]."', vale_transporte='".$this->DB[$x][24]."', data_promocao='".$this->dateFormater($this->DB[$x][26])."', tipo='".$this->DB[$x][29]."', situacao='".$this->DB[$x][30]."', descontar='".$this->DB[$x][31]."', receber='".$this->DB[$x][32]."', funcao='".$this->DB[$x][33]."', maior_360='".$this->DB[$x][35]."', prof_40h='".$this->DB[$x][36]."', vlt_ver='".$this->DB[$x][37]."', val_niv=0, data_FGTS='".$this->dateFormater($this->DB[$x][38])."', permanente='".$this->DB[$x][40]."', remuneracao_bruto=".$this->valueFormater($this->DB[$x][39]).", vencimento=0, flag='".$this->DB[$x][41]."', entrada='".$this->DB[$x][42]."', liquido=".$this->valueFormater($this->DB[$x][45]).", sobregrat='".$this->DB[$x][8]."', assistencia='".$this->DB[$x][9]."', medico='".$this->DB[$x][46]."', codigo_fol=".$code." WHERE matricula='".$this->DB[$x][0]."'", "UPDATE Pessoal SET nome='".$this->DB[$x][3]."', sexo='".$this->DB[$x][14]."', CPF='".$this->DB[$x][17]."', PIS_PASEP='".$this->DB[$x][18]."',  data_nascimento='".$this->dateFormater($this->DB[$x][19])."', ultimo_nome='".$this->DB[$x][34]."', codigo_fol=".$code." WHERE matricula='".$this->DB[$x][0]."'", "UPDATE RG SET identidade='".$this->DB[$x][27]."', orgao_expedidor='".$this->DB[$x][28]."', codigo_fol=".$code." WHERE matricula='".$this->DB[$x][0]."'", "UPDATE Inf_Bancaria SET conta='".$this->DB[$x][6]."', banco='".$this->DB[$x][43]."',  numero='".$this->DB[$x][44]."' WHERE matricula='".$this->DB[$x][0]."' AND codigo_fol=".$code."");
										}else{
											$aux = array("INSERT INTO Cadastros (matricula, cargo, lotacao, data_admissao, vinculo, previdencia, nivel, dep_imp_re, hora_sem, instrucao, data_afastamento, sindical, dp_sal_fam, hora_ponto, vale_transporte, data_promocao, tipo, situacao, descontar, receber, funcao, maior_360, prof_40h, vlt_ver, val_niv, data_FGTS, permanente, remuneracao_bruto, vencimento, flag, entrada, liquido, sobregrat, assistencia, medico, senha, codigo_fol) VALUES ('".$this->DB[$x][0]."', '".$this->DB[$x][10]."', '".$this->DB[$x][1]."', '".$this->dateFormater($this->DB[$x][4])."', '".$this->DB[$x][5]."', '".$this->DB[$x][7]."', '".$this->DB[$x][11]."', '".$this->DB[$x][13]."', '".$this->DB[$x][15]."', '".$this->DB[$x][16]."', '".$this->dateFormater($this->DB[$x][20])."', '".$this->DB[$x][21]."', '".$this->DB[$x][22]."', '".$this->DB[$x][23]."', '".$this->DB[$x][24]."', '".$this->dateFormater($this->DB[$x][26])."', '".$this->DB[$x][29]."', '".$this->DB[$x][30]."', '".$this->DB[$x][31]."', '".$this->DB[$x][32]."', '".$this->DB[$x][33]."', '".$this->DB[$x][35]."', '".$this->DB[$x][36]."', '".$this->DB[$x][37]."', 0, '".$this->dateFormater($this->DB[$x][38])."', '".$this->DB[$x][40]."', ".$this->valueFormater($this->DB[$x][39]).", 0, '".$this->DB[$x][41]."', '".$this->DB[$x][42]."', ".$this->valueFormater($this->DB[$x][45]).", '".$this->DB[$x][8]."', '".$this->DB[$x][9]."', '".$this->DB[$x][46]."', '".$this->passwordMaker()."', ".$code.")", "INSERT INTO Pessoal (matricula, nome, sexo, CPF, PIS_PASEP, data_nascimento, ultimo_nome, codigo_fol) VALUES ('".$this->DB[$x][0]."', '".$this->DB[$x][3]."', '".$this->DB[$x][14]."', '".$this->DB[$x][17]."', '".$this->DB[$x][18]."',  '".$this->dateFormater($this->DB[$x][19])."', '".$this->DB[$x][34]."', ".$code.")", "INSERT INTO RG (matricula, identidade, orgao_expedidor, codigo_fol) VALUES ('".$this->DB[$x][0]."', '".$this->DB[$x][27]."', '".$this->DB[$x][28]."', ".$code.")", "INSERT INTO Inf_Bancaria (matricula, conta, banco, numero, codigo_fol) VALUES ('".$this->DB[$x][0]."', '".$this->DB[$x][6]."', '".$this->DB[$x][43]."',  '".$this->DB[$x][44]."', ".$code.")");
										}
									}else if($code == 3){
										if($cont > 0){
											$aux = array("UPDATE Cadastros SET cargo='".$this->DB[$x][8]."', lotacao='".$this->DB[$x][1]."', data_admissao='".$this->dateFormater($this->DB[$x][4])."', vinculo='".$this->DB[$x][5]."', previdencia'".$this->DB[$x][7]."', nivel='".$this->DB[$x][9]."', dep_imp_re='".$this->DB[$x][11]."', hora_sem='".$this->DB[$x][13]."', instrucao='".$this->DB[$x][14]."', data_afastamento='".$this->dateFormater($this->DB[$x][18])."', sindical='".$this->DB[$x][19]."', dp_sal_fam='".$this->DB[$x][20]."', hora_ponto='".$this->DB[$x][21]."', vale_transporte='".$this->DB[$x][22]."', data_promocao='".$this->dateFormater($this->DB[$x][24])."', tipo='".$this->DB[$x][27]."', situacao='".$this->DB[$x][30]."', descontar='".$this->DB[$x][31]."', receber='".$this->DB[$x][32]."', funcao='".$this->DB[$x][33]."', maior_360='".$this->DB[$x][35]."', prof_40h='".$this->DB[$x][36]."', vlt_ver='".$this->DB[$x][37]."', 0, data_FGTS='".$this->dateFormater($this->DB[$x][44])."', permanente='".$this->DB[$x][41]."', remuneracao_bruto=".$this->valueFormater($this->DB[$x][42]).", 0, 'z', 'z', liquido=".$this->valueFormater($this->DB[$x][40]).", sobregrat='".$this->DB[$x][43]."', assistencia='".$this->DB[$x][45]."', 'z', codigo_fol=".$code." WHERE matricula='".$this->DB[$x][0]."'", "UPDATE Pessoal SET nome='".$this->DB[$x][3]."', sexo='".$this->DB[$x][12]."', CPF='".$this->DB[$x][15]."', PIS_PASEP='".$this->DB[$x][16]."',  data_nascimento='".$this->dateFormater($this->DB[$x][17])."', ultimo_nome='".$this->DB[$x][34]."', codigo_fol=".$code." WHERE matricula='".$this->DB[$x][0]."'", "UPDATE RG SET identidade='".$this->DB[$x][25]."', orgao_expedidor='".$this->DB[$x][26]."', codigo_fol=".$code." WHERE matricula='".$this->DB[$x][0]."'", "UPDATE Inf_Bancaria SET conta='".$this->DB[$x][6]."', banco='".$this->DB[$x][38]."',  numero='".$this->DB[$x][39]."' WHERE matricula='".$this->DB[$x][0]."' AND codigo_fol=".$code."");
										}else{
											$aux = array("INSERT INTO Cadastros (matricula, cargo, lotacao, data_admissao, vinculo, previdencia, nivel, dep_imp_re, hora_sem, instrucao, data_afastamento, sindical, dp_sal_fam, hora_ponto, vale_transporte, data_promocao, tipo, situacao, descontar, receber, funcao, maior_360, prof_40h, vlt_ver, val_niv, data_FGTS, permanente, remuneracao_bruto, vencimento, flag, entrada, liquido, sobregrat, assistencia, medico, senha, codigo_fol) VALUES ('".$this->DB[$x][0]."', '".$this->DB[$x][8]."', '".$this->DB[$x][1]."', '".$this->dateFormater($this->DB[$x][4])."', '".$this->DB[$x][5]."', '".$this->DB[$x][7]."', '".$this->DB[$x][9]."', '".$this->DB[$x][11]."', '".$this->DB[$x][13]."', '".$this->DB[$x][14]."', '".$this->dateFormater($this->DB[$x][18])."', '".$this->DB[$x][19]."', '".$this->DB[$x][20]."', '".$this->DB[$x][21]."', '".$this->DB[$x][22]."', '".$this->dateFormater($this->DB[$x][24])."', '".$this->DB[$x][27]."', '".$this->DB[$x][30]."', '".$this->DB[$x][31]."', '".$this->DB[$x][32]."', '".$this->DB[$x][33]."', '".$this->DB[$x][35]."', '".$this->DB[$x][36]."', '".$this->DB[$x][37]."', 0, '".$this->dateFormater($this->DB[$x][44])."', '".$this->DB[$x][41]."', ".$this->valueFormater($this->DB[$x][42]).", 0, 'z', 'z', ".$this->valueFormater($this->DB[$x][40]).", '".$this->DB[$x][43]."', '".$this->DB[$x][45]."', 'z', '".$this->passwordMaker()."', ".$code.")", "INSERT INTO Pessoal (matricula, nome, sexo, CPF, PIS_PASEP, data_nascimento, ultimo_nome, codigo_fol) VALUES ('".$this->DB[$x][0]."', '".$this->DB[$x][3]."', '".$this->DB[$x][12]."', '".$this->DB[$x][15]."', '".$this->DB[$x][16]."',  '".$this->dateFormater($this->DB[$x][17])."', '".$this->DB[$x][34]."', ".$code.")", "INSERT INTO RG (matricula, identidade, orgao_expedidor, codigo_fol) VALUES ('".$this->DB[$x][0]."', '".$this->DB[$x][25]."', '".$this->DB[$x][26]."', ".$code.")", "INSERT INTO Inf_Bancaria (matricula, conta, banco, numero, codigo_fol) VALUES ('".$this->DB[$x][0]."', '".$this->DB[$x][6]."', '".$this->DB[$x][38]."',  '".$this->DB[$x][39]."', ".$code.")");
										}
									}else if($code == 4){
										if($cont > 0){
											$aux = array("UPDATE Cadastros SET cargo='".$this->DB[$x][8]."', lotacao='".$this->DB[$x][1]."', data_admissao='".$this->dateFormater($this->DB[$x][4])."', vinculo='".$this->DB[$x][5]."', previdencia'".$this->DB[$x][7]."', nivel='".$this->DB[$x][9]."', dep_imp_re='".$this->DB[$x][11]."', hora_sem='".$this->DB[$x][13]."', instrucao='".$this->DB[$x][14]."', data_afastamento='".$this->dateFormater($this->DB[$x][18])."', sindical='".$this->DB[$x][19]."', dp_sal_fam='".$this->DB[$x][20]."', hora_ponto='".$this->DB[$x][21]."', vale_transporte='".$this->DB[$x][22]."', data_promocao='".$this->dateFormater($this->DB[$x][24])."', tipo='".$this->DB[$x][27]."', situacao='".$this->DB[$x][28]."', descontar='".$this->DB[$x][29]."', receber='".$this->DB[$x][30]."', funcao='".$this->DB[$x][31]."', maior_360='".$this->DB[$x][33]."', prof_40h='".$this->DB[$x][34]."', vlt_ver='".$this->DB[$x][35]."', 0, data_FGTS='".$this->dateFormater($this->DB[$x][36])."', permanente='z', remuneracao_bruto=".$this->valueFormater($this->DB[$x][44]).", vencimento=0, flag='z', entrada='".$this->DB[$x][37]."', liquido=".$this->valueFormater($this->DB[$x][38]).", sobregrat='".$this->DB[$x][41]."', assistencia='".$this->DB[$x][42]."', medico='z', codigo_fol=".$code." WHERE matricula='".$this->DB[$x][0]."'", "UPDATE Pessoal SET nome='".$this->DB[$x][3]."', sexo='".$this->DB[$x][12]."', CPF='".$this->DB[$x][15]."', PIS_PASEP='".$this->DB[$x][16]."',  data_nascimento='".$this->dateFormater($this->DB[$x][17])."', ultimo_nome='".$this->DB[$x][32]."', codigo_fol=".$code." WHERE matricula='".$this->DB[$x][0]."'", "UPDATE RG SET identidade='".$this->DB[$x][25]."', orgao_expedidor='".$this->DB[$x][26]."', codigo_fol=".$code." WHERE matricula='".$this->DB[$x][0]."'", "UPDATE Inf_Bancaria SET conta='".$this->DB[$x][6]."', banco='".$this->DB[$x][39]."',  numero='".$this->DB[$x][40]."' WHERE matricula='".$this->DB[$x][0]."' AND codigo_fol=".$code."");
										}else{
											$aux = array("INSERT INTO Cadastros (matricula, cargo, lotacao, data_admissao, vinculo, previdencia, nivel, dep_imp_re, hora_sem, instrucao, data_afastamento, sindical, dp_sal_fam, hora_ponto, vale_transporte, data_promocao, tipo, situacao, descontar, receber, funcao, maior_360, prof_40h, vlt_ver, val_niv, data_FGTS, permanente, remuneracao_bruto, vencimento, flag, entrada, liquido, sobregrat, assistencia, medico, senha, codigo_fol) VALUES ('".$this->DB[$x][0]."', '".$this->DB[$x][8]."', '".$this->DB[$x][1]."', '".$this->dateFormater($this->DB[$x][4])."', '".$this->DB[$x][5]."', '".$this->DB[$x][7]."', '".$this->DB[$x][9]."', '".$this->DB[$x][11]."', '".$this->DB[$x][13]."', '".$this->DB[$x][14]."', '".$this->dateFormater($this->DB[$x][18])."', '".$this->DB[$x][19]."', '".$this->DB[$x][20]."', '".$this->DB[$x][21]."', '".$this->DB[$x][22]."', '".$this->dateFormater($this->DB[$x][24])."', '".$this->DB[$x][27]."', '".$this->DB[$x][28]."', '".$this->DB[$x][29]."', '".$this->DB[$x][30]."', '".$this->DB[$x][31]."', '".$this->DB[$x][33]."', '".$this->DB[$x][34]."', '".$this->DB[$x][35]."', 0, '".$this->dateFormater($this->DB[$x][36])."', 'z', ".$this->valueFormater($this->DB[$x][44]).", 0, 'z', '".$this->DB[$x][37]."', ".$this->valueFormater($this->DB[$x][38]).", '".$this->DB[$x][41]."', '".$this->DB[$x][42]."', 'z', '".$this->passwordMaker()."', ".$code.")", "INSERT INTO Pessoal (matricula, nome, sexo, CPF, PIS_PASEP, data_nascimento, ultimo_nome, codigo_fol) VALUES ('".$this->DB[$x][0]."', '".$this->DB[$x][3]."', '".$this->DB[$x][12]."', '".$this->DB[$x][15]."', '".$this->DB[$x][16]."',  '".$this->dateFormater($this->DB[$x][17])."', '".$this->DB[$x][32]."', ".$code.")", "INSERT INTO RG (matricula, identidade, orgao_expedidor, codigo_fol) VALUES ('".$this->DB[$x][0]."', '".$this->DB[$x][25]."', '".$this->DB[$x][26]."', ".$code.")", "INSERT INTO Inf_Bancaria (matricula, conta, banco, numero, codigo_fol) VALUES ('".$this->DB[$x][0]."', '".$this->DB[$x][6]."', '".$this->DB[$x][39]."',  '".$this->DB[$x][40]."', ".$code.")");
										}
									}
									break;
