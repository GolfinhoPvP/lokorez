	...
	class DAOTelefone{
		...
		public function cadastrar(){
			...
			if(!$this->conexao->executar($sql)){
				die("Não foi possivel salvar: ".$this->telefone->getNumero());
			}
		}
		...
		public function alterar($valRef){
			...
			if(!$this->conexao->executar($sql)){
				die("Não foi possivel alterar: ".$this->telefone->getNumero());
			}
		}
		...
		public function deletar($valRef){
			...
			if(!$this->conexao->executar($sql)){
				die("Não foi possivel deletar: ".$this->telefone->getNumero());
			}
		}
		...
		public function pesquisar($valRef){
			...
			if(!$resultado){
				die("Não foi possivel selecionar: ".$this->telefone->getNumero());
			}
			return $resultado;
		}
	}
