...
Create table Calculos (
	...
	matricula Varchar(6) NOT NULL,
	data Date NOT NULL,
 Primary Key (codigo,matricula)) ENGINE = MyISAM;
...
Alter table Calculos add Foreign Key (codigo) references Eventos (codigo) on delete  restrict on update  restrict;
Alter table RG add Foreign Key (matricula) references Cadastros (matricula) on delete  restrict on update  restrict;
Alter table Inf_Bancaria add Foreign Key (matricula) references Cadastros (matricula) on delete  restrict on update  restrict;
Alter table Pessoal add Foreign Key (matricula) references Cadastros (matricula) on delete  restrict on update  restrict;
Alter table Calculos add Foreign Key (matricula) references Cadastros (matricula) on delete  restrict on update  restrict;
