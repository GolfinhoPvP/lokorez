...
<br/><table width="80%" border="0" cellpadding="0" cellspacing="0" class="texto2">
  <tr>
	...
	<td width="797" height="19" background="../../imagens/box2_b_1.png" style="background-repeat:repeat-x">&nbsp;</td>
	<td width="31"><img src="../../imagens/box2_c_2.png" width="25" height="22" /></td>
  </tr>
  <tr>
	<td background="../../imagens/box2_b_4.png" style="background-repeat:repeat-y">&nbsp;</td>
	<td height="19" ><div>C&oacute;digo: <?php echo($produto->getCodigo()); ?>, Prazo m&aacute;ximo: <?php echo($produto->getPrazoMaximo()); ?> meses. </div>
      <div>	Descri&ccedil;&atilde;o: <?php echo($produto->getDescricao()); ?></div></td>
