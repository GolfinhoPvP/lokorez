...
<?php
	...
	$op1 	=  isset($_POST['operador1']) ? $_POST['operador1'] : 0;
	$op2 	=  isset($_POST['operador2']) ? $_POST['operador2'] : 0;
...
<form id="form1" name="form1" method="post" action="">
  ...
  <p>OP2
    <label>
      ...
      <label></label>
      <input type="submit" name="div" id="divisao" value="/" />
      <input type="submit" name="exp" id="exponenciaçao" value="x^y" />
  </p>
  <p>RES
    <input name="resultado" type="text" id="resultado" size="20" maxlength="20" 
    value = "
	<?php 
